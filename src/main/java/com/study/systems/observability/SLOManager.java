...
public class SLOManager {
    ...
    // --- demo (moved from SLOManagerClient) ---
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SLIMeasurement measurement = new SLIMeasurement(availabilitySLO);
        ...
        AlertRule highErrorRate = new AlertRule(
            "HighErrorRate",
            "error_rate > 0.01",
        ...
        AlertRule highLatency = new AlertRule(
            "HighLatency",
            "p99_latency > 1.0",
        ...
        List<Alert> alerts = alertManager.evaluate(metrics);
        ...
        // Test 4: Runbook
        System.out.println("\n--- Test 4: Runbook ---");
        Runbook runbook = new Runbook("HighErrorRate");
