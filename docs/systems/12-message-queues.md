...
```java
--8<-- "com/study/systems/messagequeues/SimpleMessageQueue.java"
```
...
```java
--8<-- "com/study/systems/messagequeues/ProducerConsumer.java"
```
...
```java
--8<-- "com/study/systems/messagequeues/PubSubMessageQueue.java"
```
...
```java
--8<-- "com/study/systems/messagequeues/PriorityMessageQueue.java"
```
